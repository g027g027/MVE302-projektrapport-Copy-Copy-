...
\begin{enumerate}
    \item Målet med denna del är att undersöka när en \emph{jättekomponent} uppstår i slumpgrafen  $0.25n$ noder går mot $1$ då $n \to \infty$?
...
\subsection{Metod.}
För varje valt värde på $c$ genererades flera slumpgrafer enligt 
$G(n,p_n)$ med $p_n = c/n$. Vi använde $n = 30\,000$ och 
$c \in \{1.05,\,1.10,\,1.153,\,1.16,\,1.20,\,1.30\}$. 
Varje värde på $c$ repeterades tio gånger för att minska slumpvariationer. 

Graferna genererades med \emph{Batagelj–Brandes-algoritmen}, som 
effektivt konstruerar $G(n,p)$ i tid $\mathcal{O}(n+m)$ 
\cite{BatageljBrandes2005}. För varje graf identifierades den största 
sammanhängande komponenten med en bredd­först­sökning (BFS). Den relativa 
storleken $L_1/n$ beräknades och medelvärdet över upprepningarna 
jämfördes med den teoretiska lösningen $\beta(c)$ enligt 
\cite[Kap.~5]{jlr1999}.
